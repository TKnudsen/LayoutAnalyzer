...
class DisjoinsTestPanel extends JPanel implements MouseMotionListener {
  ...
  protected void paintComponent(Graphics gr) {
    ...
    double disjoinX = Disjoins.computeMinDisjoinMovement(rectangle0.getMinX(), rectangle0.getMaxX(),
        rectangle1.getMinX(), rectangle1.getMaxX());
    double disjoinY = Disjoins.computeMinDisjoinMovement(rectangle0.getMinY(), rectangle0.getMaxY(),
    ...
    Rectangle2D r = new Rectangle2D.Double(rectangle0.getX() + disjoin.getX(),
        rectangle0.getY() + disjoin.getY(), rectangle0.getWidth(), rectangle0.getHeight());
