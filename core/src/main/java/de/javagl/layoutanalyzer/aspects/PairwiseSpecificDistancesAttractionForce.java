 ...
 */
public class PairwiseSpecificDistancesAttractionForce extends AbstractAspect{
    /**
     ...
     */
    public PairwiseSpecificDistancesAttractionForce(Map<LayoutObject, Map<LayoutObject, Double>> pairwiseDistances) {
    ...
    private void computeForce(LayoutData layoutData, LayoutObject layoutObject0, LayoutObject layoutObject1) {
        ...
        if (attractionDistance == null) return;
